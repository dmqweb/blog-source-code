...
# 静态文件目录
```yml
statics: / #//gcore.jsdelivr.net/gh/amehime/shoka@latest/
```
默认值是`/`，指使用本地静态文件
可以修改成`//gcore.jsdelivr.net/gh/您的github用户名/您的项目名@latest/`这种形式，以使用jsDelivr进行加速。
...
social:
  ...
  npm: https://npmjs.com/yourname || npm || "fab fa-npm"
